...
export class JournalComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.journalService
      ...
      .subscribe(
        (res: HttpResponse<IJournal[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IJournal[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

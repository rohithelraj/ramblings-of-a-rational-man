...
To build the final jar and optimize the ramblingsOfARationalMan application for production, run:
...
[definitelytyped]: https://definitelytyped.org/ '# ramblings-of-a-rational-man'

"# ramblings-of-a-rational-man"
